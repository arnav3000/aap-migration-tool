...
RESOURCE_REGISTRY: dict[str, ResourceTypeInfo] = {
    ...
    "organizations": ResourceTypeInfo(
        ...
        migration_order=40,  # After instance_groups (30)
        cleanup_order=140,
        has_exporter=True,
        has_importer=True,
    ...
    "labels": ResourceTypeInfo(
        ...
        endpoint="labels/",
        description="Labels",
        migration_order=50,  # After organizations (40)
    ...
    "users": ResourceTypeInfo(
        ...
        endpoint="users/",
        description="Users",
        migration_order=60,  # After labels (50)
    ...
    "teams": ResourceTypeInfo(
        ...
        endpoint="teams/",
        description="Teams",
        migration_order=70,  # After users (60)
    ...
    "credential_types": ResourceTypeInfo(
        ...
        migration_order=80,  # After teams (70)
        cleanup_order=100,
        has_exporter=True,
        has_importer=True,
        has_transformer=False,
    ...
    "credentials": ResourceTypeInfo(
        ...
        migration_order=90,  # After credential_types (80)
        cleanup_order=90,
        has_exporter=True,
        has_importer=True,
    ...
    "credential_input_sources": ResourceTypeInfo(
        ...
        migration_order=100,  # After credentials (90)
        cleanup_order=85,
        has_exporter=True,
        has_importer=True,
        has_transformer=True,
    ...
    "execution_environments": ResourceTypeInfo(
        ...
        migration_order=110,  # After credential_input_sources (100)
    ...
    "instance_groups": ResourceTypeInfo(
        ...
        migration_order=30,  # After instances (20), before organizations (40)
    ...
    "projects": ResourceTypeInfo(
        ...
        migration_order=130,  # After notification_templates (120), before inventories (140)
    ...
    "inventories": ResourceTypeInfo(
        ...
        migration_order=140,  # After projects (130)
        cleanup_order=60,
        has_exporter=True,
        has_importer=True,
        has_transformer=True,
    ...
    "inventory_sources": ResourceTypeInfo(
        ...
        migration_order=150,  # After inventories (140)
        cleanup_order=70,
        has_exporter=True,
        has_importer=True,
    ...
    "inventory_groups": ResourceTypeInfo(
        ...
        migration_order=190,  # After hosts (180) — matches Ansible role order
        cleanup_order=50,
    ...
    "hosts": ResourceTypeInfo(
        ...
        endpoint="hosts/",
        description="Hosts",
        migration_order=170,  # After applications (160)
        cleanup_order=40,
        has_exporter=True,
        has_importer=True,
        has_transformer=False,
    ...
    "host_inventory_memberships": ResourceTypeInfo(
        ...
        migration_order=180,  # After hosts (170), before inventory_groups (190)
    ...
    "instances": ResourceTypeInfo(
        ...
        migration_order=20,  # Early — matches Ansible role order (2nd)
    ...
    "job_templates": ResourceTypeInfo(
        ...
        migration_order=200,  # After inventory_groups (190)
        cleanup_order=20,
        has_exporter=True,
        has_importer=True,
        has_transformer=True,
    ...
    "workflow_job_templates": ResourceTypeInfo(
        ...
        migration_order=210,  # After job_templates (200)
        cleanup_order=10,
        has_exporter=True,
        has_importer=True,
        has_transformer=True,
    ...
    "system_job_templates": ResourceTypeInfo(
        ...
        migration_order=215,  # Before schedules (220)
    ...
    "schedules": ResourceTypeInfo(
        ...
        migration_order=220,  # After workflow_job_templates (210)
        cleanup_order=30,
        has_exporter=True,
        has_importer=True,
        has_transformer=False,
    ...
    "notification_templates": ResourceTypeInfo(
        ...
        migration_order=120,  # After execution_environments (110), before projects (130)
    ...
    "applications": ResourceTypeInfo(
        ...
        migration_order=160,  # After inventory_sources (150), before hosts (170)
    ...
    "settings": ResourceTypeInfo(
        ...
        migration_order=10,  # First — matches Ansible role order
