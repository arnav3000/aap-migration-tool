...
@click.option(
    ...
    "-c",
    multiple=True,
    help="Specific checks to run (default: all). Available: pending_deletion, duplicates, orphaned_references, job_template_validation, project_validation, inventory_source_validation, schedule_validation, playbook_validation, scm_source_validation",
)
@click.option(
    "--strict",
    is_flag=True,
