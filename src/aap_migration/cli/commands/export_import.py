                ...
                for rtype, description, total_count in phases:
                    ...
                    if not dry_run:
                        ...
                        method_map = {
                            ...
                            "host_group_memberships": "import_host_group_memberships",
                        ...
                        if method_name and hasattr(importer, method_name):
                            ...
                            # --- Post-phase: Deferred constructed inventory sync ---
                            # Runs after host_group_memberships import so that hosts,
                            # host-inventory memberships, and host-group memberships
                            # are all fully established before the constructed inventory
                            # plugin evaluates its input inventories.
                            if rtype == "host_group_memberships":
                                try:
