            ...
            if resource_type == "projects" and completed > 0:
                ...
                try:
                    ...
                    patch_result = subprocess.run(
                        patch_cmd, check=False, capture_output=False, text=True
                    )
                    ...
                    if patch_result.returncode == 0:
                        ...
                        echo_warning(
                            f"⚠️  Project patching exited with code {patch_result.returncode}"
                        )
                    ...
                    echo_warning(
                        "⚠️  Project patching failed - job templates may fail if playbooks are missing"
                    )
